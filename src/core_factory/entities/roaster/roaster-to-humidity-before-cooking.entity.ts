...
export class RoasterToHumidityBeforeCooking extends CoreEntity {
  ...
  @ManyToOne(
    () => Roaster,
    (roaster) => roaster.roasterToHumidityBeforeCookings,
    {
      onUpdate: 'CASCADE',
      onDelete: 'CASCADE',
  ...
  @ManyToOne(() => Branch, (branch) => branch.roasterToHumidityBeforeCookings, {
    onUpdate: 'CASCADE',
    onDelete: 'CASCADE',
    orphanedRowAction: 'delete',
  })
  ...
  @ManyToOne(
    () => CashewStage,
    (cashewStage) => cashewStage.roasterToHumidityBeforeCookings,
    {
      onUpdate: 'CASCADE',
      onDelete: 'CASCADE',
      orphanedRowAction: 'delete',
