...
export class QapeelingToTestaKernel extends CoreEntity {
  @IsOptional()
  @IsDateString()
  @ApiPropertyOptional({ description: `Date` })
  @Column({
    name: 'qapeeling_to_testa_kernel_date',
    type: 'datetime',
    nullable: true,
  ...
  @ManyToOne(() => Shift, (shift) => shift.qapeelingToTestaKernels, {
    onUpdate: 'CASCADE',
    onDelete: 'CASCADE',
  ...
  @ManyToOne(() => Branch, (branch) => branch.qapeelingToTestaKernels, {
    onUpdate: 'CASCADE',
    onDelete: 'CASCADE',
    orphanedRowAction: 'delete',
  })
  ...
  @ManyToOne(
    () => CashewStage,
    (cashewStage) => cashewStage.qapeelingToTestaKernels,
    {
      onUpdate: 'CASCADE',
      onDelete: 'CASCADE',
      orphanedRowAction: 'delete',
