...
export class QashellingToPercentageOfKernel extends CoreEntity {
  @IsOptional()
  @IsInt()
  ...
  @ManyToOne(
    () => Qashelling,
    (qashelling) => qashelling.qashellingToPercentageOfKernels,
    {
      onUpdate: 'CASCADE',
      onDelete: 'CASCADE',
  ...
  @ManyToOne(() => Shift, (shift) => shift.qashellingToPercentageOfKernels, {
    onUpdate: 'CASCADE',
    onDelete: 'CASCADE',
    orphanedRowAction: 'delete',
  })
  ...
  @ManyToOne(() => Branch, (branch) => branch.qashellingToPercentageOfKernels, {
    onUpdate: 'CASCADE',
    onDelete: 'CASCADE',
    orphanedRowAction: 'delete',
  })
  ...
  @ManyToOne(
    () => CashewStage,
    (cashewStage) => cashewStage.qashellingToPercentageOfKernels,
    {
      onUpdate: 'CASCADE',
      onDelete: 'CASCADE',
      orphanedRowAction: 'delete',
