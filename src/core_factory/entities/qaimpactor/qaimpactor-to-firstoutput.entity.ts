...
export class QaimpactorToFirstOutput extends CoreEntity {
  @IsOptional()
  @IsInt()
  ...
  @ManyToOne(
    () => Qaimpactor,
    (qaimpactor) => qaimpactor.qaimpactorToFirstOutputs,
    {
      onUpdate: 'CASCADE',
      onDelete: 'CASCADE',
  ...
  @ManyToOne(() => Shift, (shift) => shift.qaimpactorToFirstOutputs, {
    onUpdate: 'CASCADE',
    onDelete: 'CASCADE',
    orphanedRowAction: 'delete',
  })
  ...
  @ManyToOne(() => Branch, (branch) => branch.qaimpactorToFirstOutputs, {
    onUpdate: 'CASCADE',
    onDelete: 'CASCADE',
    orphanedRowAction: 'delete',
  })
  ...
  @ManyToOne(
    () => CashewStage,
    (cashewStage) => cashewStage.qaimpactorToFirstOutputs,
    {
      onUpdate: 'CASCADE',
      onDelete: 'CASCADE',
      orphanedRowAction: 'delete',
