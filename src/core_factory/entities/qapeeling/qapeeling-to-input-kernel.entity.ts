...
export class QapeelingToInputKernel extends CoreEntity {
  @IsOptional()
  @IsDateString()
  @ApiPropertyOptional({ description: `Date` })
  @Column({
    name: 'qapeeling_to_input_kernel_date',
    type: 'datetime',
    nullable: true,
  ...
  @IsOptional()
  @IsInt()
  @ApiProperty({ required: false, description: `Poids/pourcentage %` })
  @Column({
    name: 'quantity',
    type: 'integer',
    unsigned: true,
  ...
  @ManyToOne(() => Shift, (shift) => shift.qapeelingToInputKernels, {
    onUpdate: 'CASCADE',
    onDelete: 'CASCADE',
  ...
  @ManyToOne(() => Branch, (branch) => branch.qapeelingToInputKernels, {
    onUpdate: 'CASCADE',
    onDelete: 'CASCADE',
    orphanedRowAction: 'delete',
  })
  ...
  @ManyToOne(
    () => CashewStage,
    (cashewStage) => cashewStage.qapeelingToInputKernels,
    {
      onUpdate: 'CASCADE',
      onDelete: 'CASCADE',
      orphanedRowAction: 'delete',
