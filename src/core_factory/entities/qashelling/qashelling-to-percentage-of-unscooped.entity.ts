...
export class QashellingToPercentageOfUnscooped extends CoreEntity {
  @IsOptional()
  @IsInt()
  ...
  @ManyToOne(
    () => Qashelling,
    (qashelling) => qashelling.qashellingToPercentageOfUnscoopeds,
    {
      onUpdate: 'CASCADE',
      onDelete: 'CASCADE',
  ...
  @ManyToOne(() => Shift, (shift) => shift.qashellingToPercentageOfUnscoopeds, {
    onUpdate: 'CASCADE',
    onDelete: 'CASCADE',
    orphanedRowAction: 'delete',
  })
  ...
  @ManyToOne(
    () => Branch,
    (branch) => branch.qashellingToPercentageOfUnscoopeds,
    {
      onUpdate: 'CASCADE',
      onDelete: 'CASCADE',
      orphanedRowAction: 'delete',
  ...
  @ManyToOne(
    () => CashewStage,
    (cashewStage) => cashewStage.qashellingToPercentageOfUnscoopeds,
    {
      onUpdate: 'CASCADE',
      onDelete: 'CASCADE',
      orphanedRowAction: 'delete',
