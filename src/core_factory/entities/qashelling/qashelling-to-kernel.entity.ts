...
export class QashellingToKernel extends CoreEntity {
  @IsOptional()
  @IsInt()
  ...
  @ManyToOne(() => Qashelling, (qashelling) => qashelling.qashellingToKernels, {
    onUpdate: 'CASCADE',
    onDelete: 'CASCADE',
  ...
  @ManyToOne(() => Shift, (shift) => shift.qashellingToKernels, {
    onUpdate: 'CASCADE',
    onDelete: 'CASCADE',
    orphanedRowAction: 'delete',
  })
  ...
  @ManyToOne(() => Branch, (branch) => branch.qashellingToKernels, {
    onUpdate: 'CASCADE',
    onDelete: 'CASCADE',
    orphanedRowAction: 'delete',
  })
  ...
  @ManyToOne(
    () => CashewStage,
    (cashewStage) => cashewStage.qashellingToKernels,
    {
      onUpdate: 'CASCADE',
      onDelete: 'CASCADE',
      orphanedRowAction: 'delete',
